...
class TextInputOutlined extends React.Component<ChildTextInputProps> {
    ...
    render() {
        ...
        const baseLabelTranslateX =
            ...
            (labelHalfWidth - (labelScale * labelWidth) / 2 - (fontSize - MINIMIZED_LABEL_FONT_SIZE) * labelScale);

        let labelTranslationXOffset = 0;
        const isAdornmentLeftIcon = adornmentConfig.some(
            ({ side, type }) => side === AdornmentSide.Left && type === AdornmentType.Icon,
        );
        ...
        const paddingSettings = {
            ...
            styles: StyleSheet.flatten(dense ? styles.inputOutlinedDense : styles.inputOutlined) as Padding,
        };
        ...
        const minHeight = (height || (dense ? MIN_DENSE_HEIGHT : MIN_HEIGHT)) as number;
...
const Outline = ({ theme, hasActiveOutline, activeColor, outlineColor, backgroundColor }: OutlineProps) => (
    <View
        pointerEvents="none"
        style={[
            styles.outline,
