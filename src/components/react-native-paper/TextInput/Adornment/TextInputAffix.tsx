...
import { Text, StyleSheet, StyleProp, TextStyle, LayoutChangeEvent, Animated, ViewStyle } from 'react-native';
...
> = ({ affix, side, textStyle, topPosition, onLayout, visible, paddingHorizontal }) => {
    return (
...
const TextInputAffix = ({ text, textStyle: labelStyle, theme }: Props) => {
    const { textStyle, onLayout, topPosition, side, visible, paddingHorizontal } = React.useContext(AffixContext);
