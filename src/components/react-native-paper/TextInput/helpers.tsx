...
export const calculateLabelTopPosition = (labelHeight: number, height = 0, optionalPadding = 0): number => {
    const customHeight = height > 0 ? height : 0;

    return Math.floor((customHeight - labelHeight) / 2 + optionalPadding);
};

export const calculateInputHeight = (labelHeight: number, height: any = 0, minHeight: number): number => {
...
export const interpolatePlaceholder = (labeled: Animated.Value, hasActiveOutline: boolean | undefined) =>
    labeled.interpolate({
        inputRange: [0, 1],
...
export const calculateFlatInputHorizontalPadding = ({ adornmentConfig }: { adornmentConfig: AdornmentConfig[] }) => {
